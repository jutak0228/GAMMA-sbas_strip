...
while read line; do echo "$line $ref_date $rglks $azlks" >> bperp_file_rgaz; done < bperp_file_tmp # index master slave ref_date rglks azlks
...
run_all bperp_file '../sh/mcf_sequence_with_multi_cpx diff/$2_$3.diff0.adf3 diff/$2_$3.off diff/$2_$3.diff0.adf3.unw 4 4 0.2'
